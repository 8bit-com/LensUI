...
class MobileMetricsService {
    ...
    MobileMetricsService(MobileKubernetesClient client) {
        this.client = client;
    }

    PodResourceMetrics podMetrics(String namespace, String podName) throws ApiException {
        Object response = client.customObjectsApi()
    ...
    private BigDecimal decimal(String value) {
        String cleanValue = value == null || value.trim().isEmpty() ? "0" : value;
